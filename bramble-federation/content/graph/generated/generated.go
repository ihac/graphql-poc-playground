...
func (ec *executionContext) _Query_service(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNService2ᚖgithubᚗcomᚋihacᚋgraphqlᚑpocᚑplaygroundᚋbrambleᚑfederationᚋcontentᚋgraphᚋmodelᚐService(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNService2ᚖgithubᚗcomᚋihacᚋgraphqlᚑpocᚑplaygroundᚋbrambleᚑfederationᚋcontentᚋgraphᚋmodelᚐService(ctx context.Context, sel ast.SelectionSet, v *model.Service) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOContentItem2ᚖgithubᚗcomᚋihacᚋgraphqlᚑpocᚑplaygroundᚋbrambleᚑfederationᚋcontentᚋgraphᚋmodelᚐContentItem(ctx context.Context, sel ast.SelectionSet, v *model.ContentItem) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._ContentItem(ctx, sel, v)

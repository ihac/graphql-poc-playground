...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "AdvtItem.trackerUrl":
		if e.complexity.AdvtItem.TrackerURL == nil {
			break
		}

		return e.complexity.AdvtItem.TrackerURL(childComplexity), true
...
func (ec *executionContext) _AdvtItem_trackerUrl(ctx context.Context, field graphql.CollectedField, obj *model.AdvtItem) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Query_advtItem(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be *github.com/ihac/graphql-poc-playground/bramble-federation/ads/graph/model.AdvtItem`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_service(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNService2ᚖgithubᚗcomᚋihacᚋgraphqlᚑpocᚑplaygroundᚋbrambleᚑfederationᚋadsᚋgraphᚋmodelᚐService(ctx, field.Selections, res)
}
...
var advtItemImplementors = []string{"AdvtItem"}
...
func (ec *executionContext) _AdvtItem(ctx context.Context, sel ast.SelectionSet, obj *model.AdvtItem) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "trackerUrl":
			out.Values[i] = ec._AdvtItem_trackerUrl(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
...
func (ec *executionContext) marshalNService2githubᚗcomᚋihacᚋgraphqlᚑpocᚑplaygroundᚋbrambleᚑfederationᚋadsᚋgraphᚋmodelᚐService(ctx context.Context, sel ast.SelectionSet, v model.Service) graphql.Marshaler {
	return ec._Service(ctx, sel, &v)
}

func (ec *executionContext) marshalNService2ᚖgithubᚗcomᚋihacᚋgraphqlᚑpocᚑplaygroundᚋbrambleᚑfederationᚋadsᚋgraphᚋmodelᚐService(ctx context.Context, sel ast.SelectionSet, v *model.Service) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOAdvtItem2ᚖgithubᚗcomᚋihacᚋgraphqlᚑpocᚑplaygroundᚋbrambleᚑfederationᚋadsᚋgraphᚋmodelᚐAdvtItem(ctx context.Context, sel ast.SelectionSet, v *model.AdvtItem) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
